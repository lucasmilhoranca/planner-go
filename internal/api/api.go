...
import (
	...
	"journey-go/internal/api/spec"
	"journey-go/internal/pgstore"
...
func (api *API) PostTrips(w http.ResponseWriter, r *http.Request) *spec.Response {
	...
	if err != nil {
		return spec.PostTripsJSON400Response(spec.Error{Message: "failed to create trip, try again" + err.Error()})
	}
